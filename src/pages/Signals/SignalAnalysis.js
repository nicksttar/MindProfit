...
import { getAiSignalAnalysis } from '../../services/geminiApi'; // Предполагаем, что есть функция для AI анализа
import { getCoinNews } from '../../services/newsApi'; // Предполагаем, что есть функция для получения новостей
