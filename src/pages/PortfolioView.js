...
export default function PortfolioView({ userId }) {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            // Если любой из запросов неудачен, можем установить общее сообщение об ошибке
            // или обрабатывать их по-разному.
    ...
    return (
        <div>
            <div className="text-center mb-5">
                ...
                <p className="lead" style={{color: '#9CA3AF'}}>Ваш обзор портфелей и быстрый доступ к управлению.</p>
            </div>
